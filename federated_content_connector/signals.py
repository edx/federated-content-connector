...
def handle_courseoverview_import_course_details(sender, courserun_key): # pylint: disable=unused-argument
...
def handle_courseoverview_delete_course_details(sender, courserun_key): # pylint: disable=unused-argument

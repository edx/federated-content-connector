...
"""
federated-content-connector documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'federated-content-connector',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/federated-content-connector",
...
#
# html_title = 'federated-content-connector v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'federated_content_connector'),
                os.path.join(root_path, 'federated_content_connector/migrations')])

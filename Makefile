...
test: clean ## run tests in the current virtualenv
	PYTHONPATH=./:./mock_apps pytest -r f
...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd federated_content_connector && ../manage.py makemessages -l en -v1 -d django
	cd federated_content_connector && ../manage.py makemessages -l en -v1 -d djangojs

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd federated_content_connector && ../manage.py compilemessages

detect_changed_source_translations:
	cd federated_content_connector && i18n_tool changed
...
dummy_translations: ## generate dummy translation (.po) files
	cd federated_content_connector && i18n_tool dummy
